...
const Login = () => {
  ...
  const handleLogin = async (e: any) => {
    try {
      // console.log("ini hasil", formData);
      console.log("dsfdsd", e);

      if (
        e.username !== dataDummyLogin.username ||
        e.password !== dataDummyLogin.password
      ) {
  ...
  return (
    <div className="flex">
      <div className="h-screen flex flex-1 justify-center items-center">
        <label className="swap swap-rotate absolute top-2 left-2">
          <input
            onClick={toggleTheme}
            type="checkbox"
